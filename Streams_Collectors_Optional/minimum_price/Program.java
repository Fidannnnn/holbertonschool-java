 import java.util.List;
    ...
    public class Program {
        public static void main(String[] args) {
            ...
            List<Product> minimumProducts1 = Query.getProductsByMinimumPrice(order1.getProducts(), 25);
            List<Product> minimumProducts2 = Query.getProductsByMinimumPrice(order2.getProducts(), 500);
            List<Product> minimumProducts3 = Query.getProductsByMinimumPrice(order3.getProducts(), 30);

            System.out.println(minimumProducts1);
            System.out.println(minimumProducts2);
            System.out.println(minimumProducts3);
        }
    }